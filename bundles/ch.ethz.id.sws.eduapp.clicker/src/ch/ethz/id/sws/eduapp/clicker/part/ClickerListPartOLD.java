...
public class ClickerListPartOLD {

    private static final Logger LOG = LoggerFactory.getLogger(ClickerListPartOLD.class);
	...
	private void createTable(Composite parent, EMenuService menuService, EduAppDBHelperFactory dbHelperFactory) {
        ...
        EduAppHelper.createTextFilter(filterLine, new ModifyListener() {
            ...
            public void modifyText(final ModifyEvent event) {
                ...
                ClickerListPartOLD.this.filterByText .setText(text.getText());
                ClickerListPartOLD.this.viewer.refresh();
            }
        }, new KeyAdapter() {
            @Override
            public void keyPressed(final KeyEvent event) {
                if (event.keyCode == 13 || event.keyCode == SWT.ESC || event.keyCode == SWT.ARROW_DOWN) {
                    handleSelection(ClickerListPartOLD.this.viewer, event.keyCode == SWT.ARROW_DOWN);
                    ClickerListPartOLD.this.viewer.getTable().forceFocus();
                }
            }
	       ...
	       final TableViewer out = new TableViewer(parent, SWT.H_SCROLL | SWT.V_SCROLL | SWT.FULL_SELECTION | SWT.BORDER);
	        ...
	        out.addSelectionChangedListener(new ISelectionChangedListener() {
	            ...
	            public void selectionChanged(final SelectionChangedEvent event) {
	                ...
	                ClickerListPartOLD.this.selectionService
	        ...
	        out.getControl().addKeyListener(new KeyAdapter() {
	            ...
	            public void keyPressed(final KeyEvent event) {
	                if (event.keyCode == SWT.DEL) {
	                    DeleteHandler.deleteClicker((Clicker) ClickerListPartOLD.this.selectionService.getSelection(),
	                            ClickerListPartOLD.this.broker, parent.getShell(), dbHelperFactory,
	                            ClickerListPartOLD.this.messageRegistry.getMessages());
	                }
	            }
	        });
